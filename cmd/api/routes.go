...
func (app *application) routes() http.Handler {
	...
	//router.HandlerFunc(http.MethodGet, "/v2/platform/products", app.productsHandler)
	...
	router.HandlerFunc(http.MethodPost, "/v2/platform/fulfillments/tracking", app.shopifyV2FulfillmentTrackingUpdateHandler)
	...
	router.HandlerFunc(http.MethodPost, "/v1/vendors/orders", app.processRimanOrderApi)
	router.HandlerFunc(http.MethodPost, "/v1/vendors/orders/shipping", app.updateShippingAddress)
	...
	router.HandlerFunc(http.MethodPost, "/v1/services/address/validation", app.addressValidation)
